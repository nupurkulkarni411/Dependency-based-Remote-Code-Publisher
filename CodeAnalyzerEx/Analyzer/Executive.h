...
namespace CodeAnalysis
{
  ...
  public:
	...
	void requirement2();
	void requirement3(int argc, char* argv[]);
	void requirement4();
	void requirement5(int argc, char* argv[]);
	void requirement8(int argc, char* argv[]);
	void generateHTML(int argc, char* argv[]);
	void DelDirectory(std::string& directory);
	void setPath(std::string &path);
	void setPattern(std::vector<std::string>&patterns);
	void setOptions();
	int AnalysisPreprocessing();
  private:
